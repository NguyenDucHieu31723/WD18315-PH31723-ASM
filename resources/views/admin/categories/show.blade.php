                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6 align-self-center">
                            <img src="{{ asset($category->image) }}" alt class="mx-auto d-block sm_w_100" height="300" />
                        </div>
                        ...
                        <div class="col-lg-6 align-self-center">
                            <div class="single-pro-detail">
                                ...
                                <h3 class="pro-title">{{ $category->name }}</h3>
                                ...
                                <div class="quantity mt-3">
                                    <a href="{{ route('admin.categories.listCategories') }}"
